    ...
    <div class="timeline-container single">
      <div class="timeline-content">
        <div class="timeline-card timeline-detail-card">
          ...
          <div class="timeline-title text-h5 q-mb-md">Pan-STARRS 数据集</div>
          <div class="timeline-desc q-mb-lg">Pan-STARRS 拥有大面积的深度巡天数据，广泛应用于变星、超新星等领域。</div>
          <!-- Target List -->
          <q-card class="q-mb-md">
            <q-card-section>
              <div class="text-h6">目标列表</div>
              <div class="text-body2 q-mb-md">
                Enter target coordinates or upload a CSV file with the following columns:
                id, ra, dec
              </div>
              ...
              <!-- Manual Entry -->
              <div class="text-subtitle2 q-mb-sm">Or enter coordinates manually:</div>
          ...
          <q-card class="q-mb-md">
            <q-card-section>
              ...
              <q-form @submit="onSubmit" class="q-gutter-md">
                ...
                <!-- DS9 Options -->
                <div v-if="form.visualization === 'ds9'" class="row q-col-gutter-md">
                  <div class="col-12">
                    <q-input
...
export default defineComponent({
  ...
  setup () {
    ...
    const bandOptions = [
      { label: 'g band', value: 'g' },
      { label: 'r band', value: 'r' },
      { label: 'i band', value: 'i' },
      { label: 'z band', value: 'z' },
      { label: 'y band', value: 'y' }
    ]
