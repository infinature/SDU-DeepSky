...
if system == 'Windows':
    DS9_PATH = r'D:\Program Files\SAOImageDS9\ds9.exe'
elif system == 'Darwin':  # macOS
    DS9_PATH = '/Applications/SAOImageDS9.app/Contents/MacOS/ds9'
else:  # Linux
    DS9_PATH = '/usr/bin/ds9'  # 默认路径，可能需要根据实际安装位置修改

# 检查DS9是否存在
if USE_DS9 and not os.path.exists(DS9_PATH):
    print(f"Warning: DS9 not found at {DS9_PATH}")
    print("Please install SAOImage DS9 or update the DS9_PATH in the script")
    USE_DS9 = False
