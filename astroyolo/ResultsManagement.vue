<template>
  <q-page class="results-management-page">
    <!-- 顶部标题区域 -->
    <div class="page-header q-pb-md">
      <h1 class="page-title q-my-none flex items-center">
        <q-icon name="insights" size="md" class="q-mr-sm text-secondary" />
        检测结果管理
      </h1>
      <div class="page-subtitle text-grey-4 q-mt-xs">查看、分析和导出天体检测结果</div>
    </div>

    <!-- 搜索和过滤工具栏 -->
    <q-card class="search-card q-mb-lg animation-slide-up">
      <q-card-section>
          ...
          <div class="col-12 col-md-5">
            ...
            >
              ...
              <template v-slot:append v-if="searchText">
                <q-icon name="close" color="grey" class="cursor-pointer" @click="searchText = ''" />
              </template>
            </q-input>
          </div>
    ...
    <div class="row q-col-gutter-md q-mb-lg animation-fade-in" style="animation-delay: 200ms">
      <div class="col-12 col-sm-6 col-md-3">
        <q-card class="stat-card blue-card text-white card-hover">
          <q-card-section>
            <div class="stat-header flex items-center">
      ...
      <div class="col-12 col-sm-6 col-md-3">
        <q-card class="stat-card green-card text-white card-hover">
          <q-card-section>
            <div class="stat-header flex items-center">
      ...
      <div class="col-12 col-sm-6 col-md-3">
        <q-card class="stat-card orange-card text-white card-hover">
          <q-card-section>
            <div class="stat-header flex items-center">
      ...
      <div class="col-12 col-sm-6 col-md-3">
        <q-card class="stat-card purple-card text-white card-hover">
          <q-card-section>
            <div class="stat-header flex items-center">
    ...
    <!-- 检测历史表格 -->
    <q-card class="history-card animation-slide-up" style="animation-delay: 300ms">
      <q-card-section>
        <div class="table-header flex justify-between items-center q-pb-md">
          <div class="text-h6 flex items-center">
            <q-icon name="history" class="q-mr-sm text-secondary" />
            <span>检测历史</span>
          </div>
          <div>
        ...
        <q-table
          ...
          table-header-class="table-header-bg"
