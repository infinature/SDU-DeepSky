<template>
  <q-page padding style="background-color: #f7f9fc !important;">
    <div class="row justify-center">
      <div class="col-12 col-md-10">
        <div class="text-h5 q-mb-md">检测结果管理</div>
      ...
      <div class="row q-col-gutter-md q-mb-md">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <q-card class="bg-blue-1" flat>
            <q-card-section>
              <div class="text-body2 text-grey-8">总检测数量</div>
              <div class="text-subtitle1">{{ stats.total }}</div>
            </q-card-section>
          </q-card>
        </div>
        
        <div class="col-md-3 col-sm-6 col-xs-12">
          <q-card class="bg-green-1" flat>
            <q-card-section>
              <div class="text-body2 text-grey-8">今日检测</div>
              <div class="text-subtitle1">{{ stats.today }}</div>
            </q-card-section>
          </q-card>
        </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <q-card class="bg-blue-1" flat>
            <q-card-section>
              ...
              <div class="text-subtitle1">{{ stats.objects }}</div>
            </q-card-section>
          </q-card>
        </div>
        
        <div class="col-md-3 col-sm-6 col-xs-12">
          <q-card class="bg-purple-1" flat>
            <q-card-section>
              <div class="text-body2 text-grey-8">平均处理时间</div>
              <div class="text-subtitle1">{{ stats.avgTime }}s</div>
            </q-card-section>
          </q-card>
        </div>
      </div>
      ...
      <!-- 结果表格 -->
      <q-card class="q-mb-lg" flat bordered style="background-color: #ffffff;">
        <q-card-section class="row items-center">
          <div class="text-subtitle1" style="color: #333333;">检测历史</div>
          <q-space />
          <q-btn flat round icon="archive" size="sm" color="primary" @click="exportAllResults">
            <q-tooltip>导出所有结果</q-tooltip>
          </q-btn>
          <q-btn flat round icon="delete" size="sm" color="grey" @click="confirmDeleteSelected" :disable="!hasSelectedItems">
        ...
        <q-card-section class="row items-center light-section" style="background-color: #ffffff !important;">
          <q-table
          ...
          >
            <template v-slot:header="props">
              <q-tr :props="props" class="custom-header-row" style="background-color: #f0f4f8 !important;">
                <q-th auto-width style="background-color: #f0f4f8; color: #133665;">
                  <q-checkbox v-model="allSelected" @update:model-value="selectAllRows" />
                </q-th>
                <q-th v-for="col in props.cols" :key="col.name" :props="props" :class="col.classes" style="background-color: #f0f4f8; color: #133665;">
                  {{ col.label }}
                </q-th>
              </q-tr>
            </template>
            ...
            <template v-slot:body="props">
              <q-tr :props="props" class="custom-body-row" style="background-color: #ffffff !important;">
                <q-td auto-width style="background-color: #ffffff; color: #333333;">
                ...
                <q-td key="detections" :props="props">
                ...
                <q-td key="actions" :props="props">
                  <div class="row q-gutter-xs justify-center">
                    <q-btn flat round dense icon="visibility" @click="viewResult(props.row)">
                      <q-tooltip>查看</q-tooltip>
                    </q-btn>
                    <q-btn flat round dense icon="download" @click="downloadResult(props.row)">
                      <q-tooltip>下载</q-tooltip>
                    </q-btn>
                    <q-btn flat round dense icon="delete" @click="confirmDelete(props.row)">
            ...
            <template v-slot:no-data>
              <div class="full-width row flex-center q-pa-md text-negative">
                ...
                <span class="q-ml-sm">没有检测结果数据</span>
              </div>
            </template>
          </q-table>
        </q-card-section>
